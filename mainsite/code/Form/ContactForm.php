...
class ContactForm extends Form {
	...
	public function __construct($controller) {
		...
		$fields->push(TextField::create('Name', '尊姓大名')->setAttribute('placeholder', '尊姓大名'));
		$fields->push(EmailField::create('Email', '电子邮箱')->setAttribute('placeholder', '电子邮箱'));
		$fields->push(TextField::create('Social', '微信/QQ')->setAttribute('placeholder', '微信/QQ'));
