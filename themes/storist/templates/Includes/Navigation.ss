<nav id="main_nav">
	<ul>
        ...
        <li><a href="$Link('account')" <% if $Feature == 'account' || $Feature == 'operators' %> class="is-active"<% end_if %>><span class="icon"><i class="fa fa-cog"></i></span> My Account</a></li>
        ...
        <li><a href="$Link('ranking')" <% if $Feature == 'ranking' %> class="is-active"<% end_if %>><span class="icon"><i class="fa fa-trophy"></i></span> Rankings</a></li>
        <li><a href="/member/signout"><span class="icon"><i class="fa fa-sign-out"></i></span> Signout</a></li>
	</ul>
</nav>
