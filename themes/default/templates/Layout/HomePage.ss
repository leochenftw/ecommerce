...
<section id="top-up-promitoin" class="section parallax-window" data-parallax="scroll" data-image-src="/themes/default/images/yogold-bg.jpg">
	<div class="container relative text-center">
		<header><h2>优Gold会员</h2></header>
		<div class="row">
			<div class="grid_5">
				<h3>充值优惠</h3>
		...
		<div class="row call-to-action-wrapper">
			<a class="call-to-action">充值优Gold</a>
		</div>
	</div>
</section>
...
<div id="latest-update" class="section">
	<div class="container text-center">
		...
		<div class="row call-to-action-wrapper">
			<a class="call-to-action red" href="/news">去瞧瞧</a>
		</div>
	</div>
</div>
